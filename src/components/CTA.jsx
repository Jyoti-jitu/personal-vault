        ...
        <section className="py-20 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
                ...
                <div className="flex flex-col items-center gap-4">
                    <Link to="/signup" className="bg-accent hover:bg-accent-hover text-white px-10 py-5 rounded-2xl font-bold text-xl shadow-xl shadow-green-500/30 transform transition-all hover:-translate-y-1 hover:shadow-2xl active:translate-y-0">
